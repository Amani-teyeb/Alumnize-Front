          ...
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h6" sx={{ my: 5 }}>
                The best luxury program
              </Typography>

              <Typography variant="h5">
                {'lessons orgonnized by qualified techers that matches the school programs'}

                {', try to complete the different sessions from your home.'}
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h5">
                ...
                {', learn different languages and discover the e-learning... '}

                {'your Education will not be alike.'}
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>

export const authConstants = {
  ...
  ADD_PAYPIC_REQUEST: 'ADD_PAYPIC_REQUEST',
  ADD_PAYPIC_SUCCESS: 'ADD_PAYPIC_SUCCESS',
  ADD_PAYPIC_FAILURE: 'ADD_PAYPIC_FAILURE',
...
export const courseConstants = {
  ...
  ADD_VCOURSE_REQUEST: 'ADD_VCOURSE_REQUEST',
  ADD_VCOURSE_SUCCESS: 'ADD_VCOURSE_SUCCESS',
  ADD_VCOURSE_FAILURE: 'ADD_VCOURSE_FAILURE',

  GET_VCOURSES_REQUEST: 'GET_VCOURSES_REQUEST',
  GET_VCOURSES_SUCCESS: 'GET_VCOURSES_SUCCESS',
  GET_VCOURSES_FAILURE: 'GET_VCOURSES_FAILURE',
};
...
export const favConstants = {
  GET_MYCOURSES_REQUEST: 'GET_MYCOURSES_REQUEST',
  GET_MYCOURSES_SUCCESS: 'GET_MYCOURSES_SUCCESS',
  GET_MYCOURSES_FAILURE: 'GET_MYCOURSES_FAILURE',
  REST_CART: 'RESET_CART',

  ADD_MYCOURSES_REQUEST: 'ADD_MYCOURSES_REQUEST',
  ADD_MYCOURSES_SUCCESS: 'ADD_MYCOURSES_SUCCESS',
  ADD_MYCOURSES_FAILURE: 'ADD_MYCOURSES_FAILURE',
};
